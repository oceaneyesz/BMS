...
//线   
    ...
    imagepng($image,'../resources/image1.png');
	...
	<body>
		...
		<form method="post" action="test.php">
			...
			<p>验证码图片：
				...
				<img  id="captcha_img" border="1" src="../resources/image1.png" alt="" width="100" height="30">
		...
		<script>
			function change(){
			window.location.href="./captcha.php";window.close();
			}
			</script>
	</body>
</html>