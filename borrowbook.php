...
if (isset($_POST['action'])){
  if($_POST['action']==='lend'){
      ...
      else
      {
        ...
        $sql=$pdo->prepare('SELECT * FROM BMS_books WHERE `book_status`=1 AND `book_code`=:book_code');
        ...
        if($num!=0){
          ...
          $sql=$pdo->prepare('UPDATE BMS_books_index SET `book_status`=0,`book_lent`=:book_lent WHERE `book_code`=:book_code;');
          ...
          $sql=$pdo->prepare('UPDATE BMS_books_index SET `book_popular`=:book_popular WHERE `book_code`=:book_code;');
